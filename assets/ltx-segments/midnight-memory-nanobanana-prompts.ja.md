...
Prompt:
```text
画像1の狐娘を主役として固定し、画像2の夜景ボーカルブースと画像3のスタイルやタッチ、空気感を参照して生成する。  
...
Prompt:
```text
画像1の狐娘を主役として固定し、画像2のボーカルブースと画像3のスタイルやタッチ、空気感を参照して生成する。  
...
Prompt:
```text
画像1の狐娘を主役として固定し、画像2の屋上ステージと画像3のスタイルやタッチ、空気感を参照して生成する。  
...
Prompt:
```text
画像1の狐娘を主役として固定し、画像2のガラス越し都会空間と画像3のスタイルやタッチ、空気感を参照して生成する。  
...
Prompt:
```text
画像1の狐娘を主役として固定し、画像2の川沿いブリッジステージと画像3のスタイルやタッチ、空気感を参照して生成する。  
