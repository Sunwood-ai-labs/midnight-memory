...
主役は必ず [momiji-studio_0014.png](/D:/midnight-memory/assets/ltx-segments/reference-images/momiji-studio_0014.png) の狐娘に固定し、MV風のスタートフレーム用カット、顔アップ、口元可視、後段リップシンク対応を優先しています。
